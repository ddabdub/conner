...
<body>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="hero-container" data-aos="fade-in">
      ...
      <p>
        I'm a
        <span class="typed" data-typed-items="Mechanical Engineer, Designer, Creative Mind, Freelancer, "></span>
      </p>
    </div>
  </section>
  <!-- End Hero -->
              ...
              <div class="col-lg-6">
                <ul>
                  <li>
                    ...
                    <strong>Birthday:</strong> <span>26 Feb 2002</span>
                  </li>
                  <li>
                    <i class="bi bi-chevron-right"></i>
                  ...
                  <li>
                    <i class="bi bi-chevron-right"></i>
                    <strong>Location:</strong> <span>California, USA</span>
                  </li>
                </ul>
              </div>
              <div class="col-lg-6">
        ...
        <div id="main-footer" class="bg-white text-black">
          <div class="row d-flex flex-row-reverse row-h1">
            <div class="mb-5 col-md-4 item-h1">
              <a href="#" class="btn btn-white btn-outline-dark">
          ...
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <div class="testimonial-item" data-aos="fade-up">
                <p>
                  ...
                  Conner's talent for design is unparalleled. He accounts for
                  the enginnering contraints without sacrificing
                  sustainability and aesthetics. I am most impressed by his
                  motivation, maturity and enormous drive for excellence.
                  <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                </p>
                <img src="assets/img/testimonials/donald-dabdub.png" class="testimonial-img" alt="" />
                <h3>Donald Dabdub</h3>
                <h4>Professor, Advanced Power and Energy</h4>
              </div>
            </div>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item" data-aos="fade-up" data-aos-delay="100">
                ...
                <img src="assets/img/testimonials/david-kniffin.jpg" class="testimonial-img" alt="" />
                <h3>David Kniffin</h3>
                <h4>UCI Volleyball, Head Coach</h4>
              </div>
            </div>
            <!-- End testimonial item -->
        ...
        <div class="row" data-aos="fade-in">
          ...
          <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
            <form action="forms/contact.php" method="post" role="form" class="php-email-form">
              ...
              <?php if (isset($_POST['email']) && isset($_POST['subject']) && isset($_POST['message']) && isset($_POST['name'])) : ?>
